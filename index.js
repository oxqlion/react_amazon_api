...
// const apiKey = 'dde99392ca68a6017a64fb1e6d40ee6d';
// const baseUrl = `http://scraperapi.com?api_key=${apiKey}&autoparse=true`; 

const generateScraperUrl = (apiKey) => `http://scraperapi.com?api_key=${apiKey}&autoparse=true`;
